...
#define WL_MAX_SEIZING_HEIGHT 150
#define WL_TIMEOUT_MIN 0.025
...
#define WL_BASE_ICON_SIZE 1.2
#define WL_ANNOUNCER_PAUSE 0.5
#define WL_SECTOR_CAPTURE_REWARD_MULTIPLIER 10
#define WL_SECTOR_PAYOFF_PERIOD 60
...
#define WL_ASSET_REMOVAL_SAFEZONE 100
#define WL_RESPAWN_PROTECTION_DURATION 120
#define WL_ASSET_PROTECTION_DURATION 120
#define WL_ASSET_SCENE_ICON_DURATION 90
#define WL_FRIENDLY_FIRE_RECORD_DURATION 300
#define WL_FRIENDLY_FIRE_THRESHOLD 3
#define WL_FRIENDLY_FIRE_PENALTY 60
#define WL_FRIENDLY_FIRE_PENALTY_MAX 300
#define WL_MAINTENANCE_RADIUS 15
...
#define WL_GARRISON_GROUP_SIZE_MIN 2
#define WL_GARRISON_GROUP_SIZE_MAX 5
#define WL_ASSET_IRRELEVANT_RANGE 1000
#define WL_TARGET_RESET_VOTING_TIME 60

#define WL_SYNCED_TIME (call WL2_fnc_syncedTime)
#define WL_TARGET_FRIENDLY (missionNamespace getVariable format ["WL2_currentTarget_%1", WL2_playerSide])
#define WL_TARGET_ENEMY (missionNamespace getVariable format ["WL2_currentTarget_%1", WL2_enemySide])
#define WL_CONTROL_MAP (uiNamespace getVariable ["WL2_mapControl", controlNull])
#define WL_DISPLAY_MAIN (findDisplay 46)
#define WL_PLAYER_FUNDS (player getVariable ["WL2_funds", -1])
#define WL_PLAYER_REQUISITION_LIST (missionNamespace getVariable format ["WL2_purchasable_%1", WL2_playerSide])
#define WL_REQUISITION_CATEGORIES ["Infantry", "Vehicles", "Aircraft", "Naval", "Defences", "Gear", "Strategy"]
#define WL_PLAYER_VEHS (missionNamespace getVariable [format ["WL2_%1_ownedVehicles", getPlayerUID player], []])
