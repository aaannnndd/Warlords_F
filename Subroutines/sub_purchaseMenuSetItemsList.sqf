...

{
	...
	if (_className == "RemoveUnits") then {uiNamespace setVariable ["WL2_removeUnitsListID", -1 + lbSize (_display displayCtrl 101)]};
...
(_display displayCtrl 101) lbSetCurSel ((uiNamespace getVariable ["WL2_purchaseMenuLastSelection", [0, 0, 0]]) # 1);;
...
(_display displayCtrl 103) ctrlSetStructuredText parseText format [
	...
	[
		format [localize "STR_A3_WL_asset_infantry_info", WL2_maxSubordinates + 1],
	...
	(0.85 call WL2_fnc_sub_purchaseMenuGetUIScale)
];
