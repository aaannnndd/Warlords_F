...
missionNamespace setVariable ["BIS_WL_base1", blufor_base];
missionNamespace setVariable ["BIS_WL_base2", opfor_base];
...

{
	...
	_sector setVariable ["BIS_WL_value", _sector getVariable "funds"];
